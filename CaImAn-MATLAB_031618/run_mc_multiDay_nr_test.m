function run_mc_multiDay_nr_test(iterNum)
...
%adds bidirectional scanning correction pixel offset =3 (1 iter for
%testing)
...
options_mc = NoRMCorreSetParms('d1',FOV(1),'d2',FOV(2),'grid_size',[128,128],'init_batch',200,...
                ...
                'output_type','h5', 'iter',2, 'phase_flag', true, 'correct_bidir', false);

%adds bidirectional scanning correction pixel offset =3 (1 iter for
%testing)
%options_mc = NoRMCorreSetParms('d1',FOV(1),'d2',FOV(2),'grid_size',[128,128],'init_batch',200,...
%                'overlap_pre',64,'mot_uf',4,'bin_width',100,'max_shift',44,'max_dev',8,'us_fac',50,...
%                'output_type','h5', 'iter',1, 'phase_flag', true, 'correct_bidir', true,'col_shift', -3);
