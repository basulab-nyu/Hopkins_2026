...
switch options.BehaviorType
    case 'RF' %work on this
        [Behavior_split,Imaging_split,Events_split,Behavior_split_lap,Events_split_lap] = split_laps_RF(Behavior,Imaging,CSV,Events);
...
%laps/trials
for ii=1%1:5 %Maya changed for error issues 1 to a 3
    %work on this part
...
for ii=1%1:5 %Maya changed 1 to 3
...
for ii=1:size(Place_cell,2) %Maya changed 1 to 4
