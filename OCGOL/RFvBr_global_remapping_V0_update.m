function RFvBr_global_remapping_V0_update(path_dir,crossdir)
...
options.subSamp_sess = 0; 
options.subSamp_sessSelect=[1,2];
...
% %MH110 RF
%  path_dir = {'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort1_Processed_RFvOCGOL\MH110\RF\MH110_23_04_30-001_1',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort1_Processed_RFvOCGOL\MH110\RF\MH110_23_05_01-001_2'}
% %cross session directory
% crossdir = 'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort1_Processed_RFvOCGOL\MH110\RF\crossSession_update';

%MH131
 path_dir = {'R:\MH\LEC_Bilateral_Silencing\Cohort_4\MH132\BrvsRF_BrRFSes\MH132_2024_11_07_BrOnly_Saline-001_7',...
     'R:\MH\LEC_Bilateral_Silencing\Cohort_4\MH132\BrvsRF_BrRFSes\MH132_2024_11_07_RF_Saline-002_2',...
     'R:\MH\LEC_Bilateral_Silencing\Cohort_4\MH132\BrvsRF_BrRFSes\MH132_2024_11_08_BrOnly_Saline-001_3',...
     'R:\MH\LEC_Bilateral_Silencing\Cohort_4\MH132\BrvsRF_BrRFSes\MH132_2024_11_08_RF_Saline-002_4',...
     'R:\MH\LEC_Bilateral_Silencing\Cohort_4\MH132\BrvsRF_BrRFSes\MH132_2024_11_09_BrOnly_Saline-001_5',...
     'R:\MH\LEC_Bilateral_Silencing\Cohort_4\MH132\BrvsRF_BrRFSes\MH132_2024_11_09_RF_Saline-002_6',...
     'R:\MH\LEC_Bilateral_Silencing\Cohort_4\MH132\BrvsRF_BrRFSes\MH132_2024_11_10_BrOnly_Saline-001_7',...
     'R:\MH\LEC_Bilateral_Silencing\Cohort_4\MH132\BrvsRF_BrRFSes\MH132_2024_11_10_RF_Saline-002_2',...
     'R:\MH\LEC_Bilateral_Silencing\Cohort_4\MH132\BrvsRF_BrRFSes\MH132_2024_11_11_BrOnly_Saline-001_3',...
     'R:\MH\LEC_Bilateral_Silencing\Cohort_4\MH132\BrvsRF_BrRFSes\MH132_2024_11_11_RF_Saline-002_4',...
     'R:\MH\LEC_Bilateral_Silencing\Cohort_4\MH132\BrvsRF_BrRFSes\MH132_2024_11_12_BrOnly_CNO-001_5',...
     'R:\MH\LEC_Bilateral_Silencing\Cohort_4\MH132\BrvsRF_BrRFSes\MH132_2024_11_12_RF_CNO-002_6'};
%cross session directory
crossdir = 'R:\MH\LEC_Bilateral_Silencing\Cohort_4\MH132\BrvsRF_BrRFSes\crossSession_update';
...
%% Override to analyze subset of sessions from larger pre-matched group of sessions
% sessionSelect = [1 2];
% options.sessionSelect = 1:length(sessionSelect);
...
for ii = options.sessionSelect%1:size(path_dir,2)
    ...
    if endsWith(fileName,'ca_analysis.mat')
        ...
        if ismember(ii,Br_ind) %This is the workaround for comparing RF sessions to Br Only sessions; moves all Br trials (index 5) to index 1 like RF sessions
            session_vars{1, ii}.Place_cell{1, 1}=session_vars{1, ii}.Place_cell{5};
            session_vars{1, ii}.Behavior_split{1, 1}=session_vars{1, ii}.Behavior_split{5};
            session_vars{1, ii}.Events_split{1, 1}=session_vars{1, ii}.Events_split{5};  
            session_vars{1, ii}.Imaging_split{1, 1}= session_vars{1, ii}.Imaging_split{5}
        end
    end
    end
...
if options.load_ROI_zooms_outlines == 0
    ...
    [ROI_zooms, ROI_outlines] = defineOutlines_eachSes(nbSes,session_vars, path_dir, sessionSelect);
    %save to directory
...
[tunedLogical] = RF_defineTunedLogicals(session_vars,options);
...
%options.sessionSelect = [1 2 3 4 5 6];
%continue to modify 
[field_event_rates,pf_vector,field_total_events, select_fields] = RF_transient_rate_in_field_multi_ses(session_vars,options);
...
[registered] = RF_filter_matching_components(registered,tunedLogical,select_fields,options);
...
[recurr,frac_active,recurr_ex,frac_active_ex] = RF_recurrence_analysis(registered,removedROI_clean,session_vars,tunedLogical,select_fields,options);
...
[matching_tun_curves] = RF_export_day_matched_STCs(session_vars,session_vars_append,registered);
...
[tc_corr_match] = RF_tc_corr_matching_neurons(session_vars,registered,options);
...
[tc_corr_match] = RF_tc_corr_matching_neurons_si_output_hack(session_vars,registered,options,tc_corr_match);
...
[PV_TC_corr] = RF_PV_TC_corr_across_days(session_vars,tunedLogical,registered,options);

%save to output file for cumulative analysis
save(fullfile(crossdir,'PV_TC_corr.mat'),'PV_TC_corr')

%save tuned logicals
save(fullfile(crossdir,'tuned_logicals.mat'),'tunedLogical');
...
% [task_selective_ROIs] = RF_task_selective_categorize_multi_ses(tunedLogical,session_vars, max_transient_peak,options);
% 
% 
% 
...
% %options.selectTrial = [4 5];
% %options.sessionSelect = [1 2 3 4 5 6];
% [placeField_dist, pf_count_filtered_log, pf_count_filtered] = RF_placeField_properties_multi_ses(session_vars,tunedLogical,select_fields,task_selective_ROIs,options);
% 
...
% %place field
% [tuned_fractions,tuned_logicals] = RF_fractionTuned_multi_ses(tunedLogical,pf_count_filtered_log,options);
% 
