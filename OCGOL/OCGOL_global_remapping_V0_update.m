function OCGOL_global_remapping_V0_update(path_dir,crossdir)
%% Import variables and define options

%flag for running cross-session analyses on only a subset of prematched
%sessions: should only set to 1 if registration has already been done on
%a larger group of sessions. Path directory should contain only the
%sessions of interest, but this flag will index the larger registered.mat
%and filtered match files to be the appropriate sessions
options.subSamp_sess = 1; 
options.subSamp_sessSelect=[1,2,3,4];
...
% %MH110
%  path_dir = {'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Processed_SilencingSession\MH110\MH110_23_05_28_Random_Saline-001_1',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Processed_SilencingSession\MH110\MH110_23_05_29_Random_Saline-001_2',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Processed_SilencingSession\MH110\MH110_23_05_30_Random_CNO-001_3',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Processed_SilencingSession\MH110\MH110_23_05_31_Random_Saline-001_4'};
% %cross session directory
% crossdir = 'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Processed_SilencingSession\MH110\crossSession_update';

% %MH113
%  path_dir = {'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Processed_SilencingSession\MH113\MH113_23_05_25_Random_Saline-001_1',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Processed_SilencingSession\MH113\MH113_23_05_26_Random_Saline-001_2',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Processed_SilencingSession\MH113\MH113_23_05_27_Random_CNO-001_3',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Processed_SilencingSession\MH113\MH113_23_05_28_Random_Saline-001_4'};
% %cross session directory
% crossdir = 'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Processed_SilencingSession\MH113\crossSession_update';

% %MH114
%  path_dir = {'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Processed_SilencingSession\MH114\MH114_23_05_26_Random_Saline-001_1',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Processed_SilencingSession\MH114\MH114_23_05_27_Random_Saline-001_2',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Processed_SilencingSession\MH114\MH114_23_05_28_Random_CNO-001_3',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Processed_SilencingSession\MH114\MH114_23_05_29_Random_Saline-001_4'};
% %cross session directory
% crossdir = 'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Processed_SilencingSession\MH114\crossSession_update';

% %MH114
%  path_dir = {'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Processed_SilencingSession\MH114\MH114_23_05_27_Random_Saline-001_1',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Processed_SilencingSession\MH114\MH114_23_05_28_Random_CNO-001_2',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Processed_SilencingSession\MH114\MH114_23_05_29_Random_Saline-001_3'};
% %cross session directory
% crossdir = 'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Processed_SilencingSession\MH114\crossSession_update_ex_s1';

% %MH115
%  path_dir = {'D:\Bilateral_Silence\MH115\MH115_23_08_10_Random_Saline-001_1',...
%      'D:\Bilateral_Silence\MH115\MH115_23_08_11_Random_CNO-001_2',...
%      'D:\Bilateral_Silence\MH115\MH115_23_08_12_Random_Saline-001_3'};
% %cross session directory
% crossdir = 'D:\Bilateral_Silence\MH115\crossSession_update';
...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Processed_SilencingSession\MH114\MH114_23_05_29_Random_Saline-001_4'};
% %cross session directory
% crossdir = 'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Processed_SilencingSession\MH114\crossSession_update_allSes';
...
% %MH122
%  path_dir = {'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort2_Processed_SilencingSession\MH122\MH122_2024_05_03_Random_Saline-001_3',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort2_Processed_SilencingSession\MH122\MH122_2024_05_04_Random_Saline-001_4',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort2_Processed_SilencingSession\MH122\MH122_2024_05_05_Random_CNO-001_5',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort2_Processed_SilencingSession\MH122\MH122_2024_05_06_Random_Saline-002_2'};
% %cross session directory
% crossdir = 'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort2_Processed_SilencingSession\MH122\crossSession_update';

% %MH126
%  path_dir = {'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort2_Processed_SilencingSession\MH126\MH126_2024_05_03_Random_Saline-001_2',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort2_Processed_SilencingSession\MH126\MH126_2024_05_04_Random-001_3',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort2_Processed_SilencingSession\MH126\MH126_2024_05_05_Random_CNO-001_4',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort2_Processed_SilencingSession\MH126\MH126_2024_05_06_Random_Saline-001_5'};
% %cross session directory
% crossdir = 'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort2_Processed_SilencingSession\MH126\crossSession_update';

% %MH127
%  path_dir = {'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort2_Processed_SilencingSession\MH127\MH127_2024_05_02_Random_Saline-001_5',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort2_Processed_SilencingSession\MH127\MH127_2024_05_03_Random_Saline-001_6',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort2_Processed_SilencingSession\MH127\MH127_2024_05_04_Random_CNO-001_7',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort2_Processed_SilencingSession\MH127\MH127_2024_05_05_Random_Saline-001_2'};
% %cross session directory
% crossdir = 'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort2_Processed_SilencingSession\MH127\crossSession_update';

% %MH128
%  path_dir = {'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort2_Processed_SilencingSession\MH128\MH128_2024_05_06_Random_Saline-001_4',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort2_Processed_SilencingSession\MH128\MH128_2024_05_07_Random_Saline-001_5',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort2_Processed_SilencingSession\MH128\MH128_2024_05_08_Random_CNO-001_6',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort2_Processed_SilencingSession\MH128\MH128_2024_05_09_Random_Saline-001_7'};
% %cross session directory
% crossdir = 'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort2_Processed_SilencingSession\MH128\crossSession_update';

%MH110 RF
%  path_dir = {'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort3_Processed_RFvOCGOL\MH128\OCGOL\MH128_2024_05_04_Random-001_2',...
%      'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort3_Processed_RFvOCGOL\MH128\OCGOL\MH128_2024_05_05_Random-001_3'};
% %cross session directory
% crossdir = 'R:\basulab\basulabspace\MH\LEC_Bilateral_Silencing\Cohort3_Processed_RFvOCGOL\MH128\OCGOL\crossSession_update';


% %MH128
%  path_dir = {'R:\MH\LEC_Bilateral_Silencing\Cohort_4\MH136\RFvOCGOL\MH136_2024_10_11_RF_3R-001_2',...
...
% %cross session directory
% crossdir = 'R:\MH\LEC_Bilateral_Silencing\Cohort_4\MH136\RFvOCGOL\crossSession_update';

 path_dir = {'R:\MH\LEC_Bilateral_Silencing\Cohort_4\MH137\OCGOL_Sil_Recall_Rev\MH137_2024_10_29_Random_Saline-001_5',...
...
%cross session directory
crossdir = 'R:\MH\LEC_Bilateral_Silencing\Cohort_4\MH137\OCGOL_Sil_Recall_Rev\crossSession_update';
...
if options.subSamp_sess == 1; 
    disp('Subsampling registered.mat file')
    match_var.ROI_assign_multi_filtered = match_var.ROI_assign_multi_filtered(:,options.subSamp_sessSelect);
    registered.multi.assigned_filtered = registered.multi.assigned_filtered(:,options.subSamp_sessSelect);
    registered.multi.assigned = registered.multi.assigned(:,options.subSamp_sessSelect);
    registered.multi.assigned_all = registered.multi.assigned_all(:,options.subSamp_sessSelect);
    registered.session.assign_cell = registered.session.assign_cell(options.subSamp_sessSelect,options.subSamp_sessSelect);
    registered.multi.assign_cell = registered.multi.assign_cell(options.subSamp_sessSelect,options.subSamp_sessSelect);
    registered.multi.ROI_zooms = registered.multi.ROI_zooms(:,options.subSamp_sessSelect);
    registered.multi.ROI_outlines = registered.multi.ROI_outlines(:,options.subSamp_sessSelect);
end
...
rows = 20;
cols = size(path_dir,2); %take # of sessions as input
