function [all_data] = RF_extract_all_lap_data(session_vars,registered)
...
for ss=1:size(session_vars,2)
    ...
    t_order = session_vars{ss}.Behavior.performance.trialOrder; %For RF all trials are labeled as "3"
