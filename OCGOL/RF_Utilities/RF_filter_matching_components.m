...
[matching_list] = RF_filter_match_tuning_crit(matching_list,tunedLogical,select_fields,options);
...
%field
[matching_list] = RF_filter_match_min_event_PF(matching_list,select_fields,options);
