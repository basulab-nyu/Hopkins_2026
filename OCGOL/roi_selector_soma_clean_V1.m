...
% roi_selector_soma_clean_V1.m
% Inputs:
%   Input 1 : brief description
%   Input 2 : brief description
% Returns:
%   Returned data 1 : brief description (or state that it does not return data)
% Plots:
% List what data is getting plotted when you run all of this maybe?
...
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%% EVERYTHING ABOVE THIS SEEMS TO BE DUPLICATED LATER IN THIS FILE AND THEN IT DIVERGES FROM BELOW HERE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
...
% HACK
compSelect = true(1,size(selector_var.A_keep,2));
...
try
    mkdir('removedROI'); %mkdir('removedROI_clean') MH changed 10/26/23;
    cd(fullfile(exp_dir, ['/','removedROI'])); %cd(fullfile(exp_dir, ['/','removedROI_clean'])) MH changed 10/26/23
catch
...
%save all
compSelect=removedROI_clean==0; %inverse of removed ROIs to mimic compselect
