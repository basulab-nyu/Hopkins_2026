...
if ~isempty(textures) && ~isempty(find(textures.position_med >= 54 & textures.position_med <= 70))
...
elseif ~isempty(textures) && ~isempty(find(textures.position_med >= 136 & textures.position_med <= 148))
