function [Behavior] = OCGOL_performance_new_inputs_rev_Br(Behavior)
%Get performance of the animal on the OCGOL trials
%To handle sessions with only Br trials - hard coded 55 cm as the location
%of the Ar "wrong" reward zone since there are no values to calculate from
%the sessions itself since there are no Ar trials
%% Assign variables
