...
options.defineDir = 1;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%% LOOKS LIKE THESE ARE FROM WHEN PATH WAS NOT AN ARGUMENT, CAN WE DELETE THESE COMMENTS BELOW??? %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% ALSO MAKE THE BELOW AN ARGUMENT WHERE YOU PASS THE STRING FOR THE BEHAVIOR TYPE, IF IT IS NOT A RECOGNIZED STRING, OUTPUT AN ERROR MESSAGE AND END THE PROGRAM BEFORE YOU MESS WITH DATA %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
options.BehaviorType = 'OCGOL-rev-Br';
...
if options.textures == true
    ...
    switch options.BehaviorType
        ...
        case 'OCGOL-rev-Br'
            [Behavior] = extractTextures_OCGOL_rev_Br(CSV, Behavior, options);
    end
end
...
switch options.BehaviorType
   ...
   case 'OCGOL-rev-Br'
       [Behavior] = OCGOL_performance_new_inputs_rev_Br(Behavior);
end
...
switch options.BehaviorType
    ...
    case 'OCGOL-rev-Br' %work on this
        [Behavior_split,Imaging_split,Events_split,Behavior_split_lap,Events_split_lap] = split_trials_OCGOL_rev(Behavior,Imaging,Events,options);
    case 'OCGOL'
...
%laps/trials
for ii=5%3:5 %Maya changed for error issues 1:3 for rev (original is 1:5), ii=5 for Br only blocks
    %work on this part
    ...
    disp('Calculate tuning specificity score')
...
for ii=5 %1:5 for OCGOL, 3:5 for reversal, 5 for BrOnly
...
for ii=5 %for ocgol 1:size(Place_cell,2), for reversal 4:size(Place_cell,2), for BrOnly ii=5
